...
namespace Dna\Payment\Model\WeChatPay;
...
class WeChatPayPaymentMethod extends \Magento\Payment\Model\Method\AbstractMethod
{
    protected $_code = 'dna_payment_wechatpay';
